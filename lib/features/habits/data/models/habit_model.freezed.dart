...
class _$HabitModelImpl implements _HabitModel {
  ...
  @override
  String toString() {
    return 'HabitModel(id: $id, name: $name, description: $description, frequency: $frequency, icon: $icon, color: $color, streak: $streak, bestStreak: $bestStreak, totalCompleted: $totalCompleted, completedToday: $completedToday, createdAt: $createdAt)';
  }
